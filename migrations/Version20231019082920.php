 ...
 */
final class Version20231019082920 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE gathering_user (gathering_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_D84654E17BA827B5 (gathering_id), INDEX IDX_D84654E1A76ED395 (user_id), PRIMARY KEY(gathering_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE gathering_user ADD CONSTRAINT FK_D84654E17BA827B5 FOREIGN KEY (gathering_id) REFERENCES tbl_gathering (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE gathering_user ADD CONSTRAINT FK_D84654E1A76ED395 FOREIGN KEY (user_id) REFERENCES tbl_user (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE gathering_user DROP FOREIGN KEY FK_D84654E17BA827B5');
        $this->addSql('ALTER TABLE gathering_user DROP FOREIGN KEY FK_D84654E1A76ED395');
        ...
        $this->addSql('DROP TABLE gathering_user');
