 ...
 */
final class Version20231128201542 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tbl_tests (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, chart_id INT NOT NULL, vma DOUBLE PRECISION DEFAULT NULL, cooper VARCHAR(255) NOT NULL, jongle_gauche INT DEFAULT NULL, jongle_droit INT DEFAULT NULL, jongle_tete INT DEFAULT NULL, date DATETIME DEFAULT NULL, demicooper INT DEFAULT NULL, conduiteballe VARCHAR(255) DEFAULT NULL, vitesse VARCHAR(255) DEFAULT NULL, INDEX IDX_BC04B641A76ED395 (user_id), INDEX IDX_BC04B641BEF83E0A (chart_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE tbl_tests ADD CONSTRAINT FK_BC04B641BEF83E0A FOREIGN KEY (chart_id) REFERENCES tbl_charts (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tbl_tests DROP FOREIGN KEY FK_BC04B641BEF83E0A');
