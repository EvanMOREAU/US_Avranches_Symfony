...
class ChartsFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $heightConfig->setConfigData(['entity' => 'App\Entity\Height', 'min' => 100, 'max' => 200, 'paliermin' => 133, 'paliermax' => 166, 'field' => 'value', 'date_field' => 'date']);
        $manager->persist($heightConfig);

        $weightConfig = new ChartConfiguration();
        $weightConfig->setChartType('line');
        $weightConfig->setName('Poids');
        $weightConfig->setConfigData(['entity' => 'App\Entity\Weight', 'min' => 10, 'max' => 120, 'paliermin' => 46, 'paliermax' => 82, 'field' => 'value', 'date_field' => 'date']);
        ...
        $leftConfig->setConfigData(['entity' => 'App\Entity\Tests', 'min' => 0, 'max' => 50, 'paliermin' => 16, 'paliermax' => 33, 'field' => 'jonglegauche', 'date_field' => 'date']);
        ...
        $rightConfig->setConfigData(['entity' => 'App\Entity\Tests', 'min' => 0, 'max' => 50, 'paliermin' => 16, 'paliermax' => 33, 'field' => 'jongledroit', 'date_field' => 'date']);
        $manager->persist($rightConfig);

        $headConfig = new ChartConfiguration();
        $headConfig->setChartType('line');
        $headConfig->setName('Jongle tete');
        $headConfig->setConfigData(['entity' => 'App\Entity\Tests', 'min' => 0, 'max' => 30, 'paliermin' => 10, 'paliermax' => 20, 'field' => 'jongletete', 'date_field' => 'date']);
        ...
        $vmaConfig->setConfigData(['entity' => 'App\Entity\Tests', 'min' => 0, 'max' => 20, 'paliermin' => 6, 'paliermax' => 13, 'field' => 'vma', 'date_field' => 'date']);
        ...
        $cooperConfig->setConfigData(['entity' => 'App\Entity\Tests', 'min' => 0, 'max' => 20, 'paliermin' => 6, 'paliermax' => 13, 'field' => 'cooper', 'date_field' => 'date']);
        ...
        $demicooperConfig->setConfigData(['entity' => 'App\Entity\Tests', 'min' => 0, 'max' => 20, 'paliermin' => 6, 'paliermax' => 13, 'field' => 'demicooper', 'date_field' => 'date']);
        ...
        $vitesseConfig->setConfigData(['entity' => 'App\Entity\Tests', 'min' => 5, 'max' => 20, 'paliermin' => 10, 'paliermax' => 13, 'field' => 'vitesse', 'date_field' => 'date']);
