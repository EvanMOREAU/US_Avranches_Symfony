...
class ChartsFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $controlConfig->setConfigData(['entity' => 'App\Entity\Tests', 'min' => 200000, 'max' => 5000, 'field' => 'conduiteballe', 'date_field' => 'date']);
        ...
        $vitesseConfig->setConfigData(['entity' => 'App\Entity\Tests', 'min' => 200000, 'max' => 5000, 'field' => 'vitesse', 'date_field' => 'date']);
